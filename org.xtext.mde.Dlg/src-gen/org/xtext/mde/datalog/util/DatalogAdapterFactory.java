...
public class DatalogAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DatalogSwitch<Adapter> modelSwitch =
    new DatalogSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseParameterInt(ParameterInt object)
      {
        return createParameterIntAdapter();
      }
      @Override
      public Adapter caseParameterVar(ParameterVar object)
      {
        return createParameterVarAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mde.datalog.ParameterInt <em>Parameter Int</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createParameterIntAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mde.datalog.ParameterVar <em>Parameter Var</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createParameterVarAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mde.datalog.ParameterPred <em>Parameter Pred</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
